...
define(function (require, exports, module) {
    ...
    Mobilebone.rootTransition = {
        loginCheckInto: function loginCheckInto(pageInto, pageOut, callback) {
            Mobilebone.INTO = require('page/loginCheck');
            Mobilebone.OUT = Mobilebone.INTO();
        },
        loginCheckOut: function loginCheckOut(pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        },
        signInInto: function signInInto(pageInto, pageOut, callback) {
        ...
        signInOut: function signInOut(pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        },
        loginInto: function loginInto(pageInto, pageOut, callback) {
            var userPhone = oneSession.get('userPhone');
        ...
        loginOut: function loginOut(pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        }
    };
    Mobilebone.init();
...
//# sourceMappingURL=routeLogin-compiled.js.map