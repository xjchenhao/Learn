...
(function (root, factory) {
    ...
    "use strict";
    var Slider = function Slider(opts) {
        if (!opts.dom) {
    ...
    Slider.prototype._renderItem = function (i) {
        ...
        if (this.type === 'pic') {
            ...
            if (this.isAutoScale) {
                html += item.height / item.width > this.ratio ? '<img height="' + this.height + '" ' + _src + '="' + item.content + '">' : '<img width="' + this.width + '" ' + _src + '="' + item.content + '">';
            } else {
    ...
    Slider.prototype._bindHandler = function () {
        ...
        this.event = {
            ...
            orientation: function orientation(evt) {
                setTimeout(function () {
                    self.reset();
                }, 100);
            },
            ...
            lazyLoad: function lazyLoad(evt) {
                // 图片加载私有方法
                var _imgLoad = function _imgLoad(src, callback) {
                ...
                var _lazyLoad = function _lazyLoad(arr, callback) {
                    var _imgs = arr;
