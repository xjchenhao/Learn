...
(function (root, factory) {
...
})(undefined, function (root, Verifyfrom) {
    ...
    var strategies = {
        ...
        isReg: function isReg(value, reg, errorMsg) {
        ...
        serverVerify: function serverVerify(value, requestFunc) {
        ...
        verifyStart = true,
        // 触发表单校验start方法的模拟blur事件时,遇到错误就关闭校验状态,阻止进行后面的校验
    eventFunc = [],
        // blur事件的方法栈
    succeed = null,
        // 表单元素校验成功回调函数,函数有一个回调参数,即校验成功的表单元素
    ...
    Validator.prototype.add = function (dom, rules) {
        ...
        for (var i = 0, rule; rule = rules[i++];) {
            ...
            (function (rule) {
                ...
                // 生成校验函数
                var verifyFunc = function verifyFunc() {
...
//# sourceMappingURL=verifyfrom-compiled.js.map