...
define(function (require, exports, module) {
    ...
    Handlebars.registerHelper({
        equal: function equal(arg, value, options) {
            return Number(arg) == Number(value) ? options.fn(this) : options.inverse(this);
        },
        less: function less(arg, value, options) {
            return Number(arg) < Number(value) ? options.fn(this) : options.inverse(this);
        },
        lessEqual: function lessEqual(arg, value, options) {
            return Number(arg) <= Number(value) ? options.fn(this) : options.inverse(this);
        },
        greater: function greater(arg, value, options) {
            return Number(arg) > Number(value) ? options.fn(this) : options.inverse(this);
        },
        greaterEqual: function greaterEqual(arg, value, options) {
            return Number(arg) >= Number(value) ? options.fn(this) : options.inverse(this);
        },
        andFalse: function andFalse(arg1, arg2, options) {
...
//# sourceMappingURL=handlebars-helper-compiled.js.map