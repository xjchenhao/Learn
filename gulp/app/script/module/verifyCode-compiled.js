...
(function (root, factory) {
...
})(undefined, function (root, exports, cookie, encryptedPwd) {
    ...
    WAITTEXT = '秒后重新获取',
        //倒计时中按钮上文字
    URL = '/wap/user/validCode.html',
        //请求地址
    WAITTIME = 60,
        //倒计时时间
    DISIABLEDCLASS = 'disabled',
        //倒计时中的状态样式
    SHOWCLASS = 'red',
        //可获取验证码的状态样式
    ...
    var verifyCode = function verifyCode(obj) {
    ...
    verifyCode.prototype._handle = function () {
        var self = this;
        self._event = {
            getValidNum: function getValidNum() {
                var phoneKey = {};
...
//# sourceMappingURL=verifyCode-compiled.js.map