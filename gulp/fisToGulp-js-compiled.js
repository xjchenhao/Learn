...
module.exports = function () {
    ...
    return through.obj(function (file, enc, cb) {
        ...
        while ((result = regImportTpl.exec(fileContents)) != null) {
            ...
            // 读取并格式化tpl文件的文本
            var abc = fs.readFileSync(absolutePath).toString().replace(/\n/g, '').replace(/\'/g, '\\\'').replace(/\"/g, '\\\"').replace(/>\s*</g, '><').replace(/}\s*</g, '}<').replace(/>\s*\{/g, '>{');
...
//# sourceMappingURL=fisToGulp-js-compiled.js.map